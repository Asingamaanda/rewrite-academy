"""
Professional Title Cards for Waves Physics Lesson
...
class WaveTypesSectionCard(Scene):
    """Section divider for wave types with detailed subtopics"""
    ...
    def construct(self):
        ...
        objectives_title = Text("Learning Objectives:", font_size=24, color=INFO_COLOR, weight=BOLD)
        objectives_title.next_to(section_title, DOWN, buff=0.8)
        ...
        objectives.next_to(objectives_title, DOWN, buff=0.3, aligned_edge=LEFT)
        ...
        self.play(Write(objectives_title), run_time=0.6)
        ...
        # Fade out
        self.play(
            FadeOut(VGroup(section_num, section_title, objectives_title, objectives, topics_title, topics, line)),
            run_time=1
        )
...
class WaveEquationSectionCard(Scene):
    """Section divider for wave equation with detailed breakdown"""
    ...
    def construct(self):
        ...
        # Animation sequence with comprehensive details"""
    ...
    def construct(self):
        ...
        self.play(
            LaggedStart(*[FadeIn(char, shift=RIGHT*0.3) for char in characteristics], lag_ratio=0.3),
            run_time=1.5
        )
        self.wait(0.8)
        ...
        # Fade out
        self.play(
            FadeOut(VGroup(section_num, section_title, speed_label, speed, char_title, characteristics, subtopic
        speed.next_to(section_title, DOWN, buff=0.8)
        
        # Characteristics
        characteristics = VGroup(
            Text("• Longitudinal mechanical wave", font_size=24, color=GREY_A),
            Text("• Requires a medium", font_size=24, color=GREY_A),
            Text("• Speed depends on temperature", font_size=24, c with detailed structure"""
    ...
    def construct(self):
        ...
        self.play(
            LaggedStart(*[FadeIn(detail, shift=RIGHT*0.2) for detail in em_details], lag_ratio=0.3),
            run_time=1.5
        )
        self.wait(1)
        ...
        self.play(
            LaggedStart(*[FadeIn(detail, shift=RIGHT*0.2) for detail in energy_details], lag_ratio=0.3),
            run_time=1.5
        )
        self.wait(2.5)
        ...
        self.play(FadeOut(all_objects), run_time=1    Text("Electromagnetic Waves", font_size=32, color=WHITE),
            MathTex("c = 3 \\times 10^8 \\text{ m/s}", font_size=36, color=INFO_COLOR),
            Text("Photon Energy", font_size=32, color=WHITE),
            MathTex("E = hf", font_size=48, color=ACCENT_COLOR)
        ).arrange(DOWN, buff=0.5)
        concepts.next_to(section_title, DOWN, buff=1)
        
        # Decorative line
        line = Line(LEFT*4, RIGHT*4, color=LIGHT_COLOR, stroke_width=3)
        line.next_to(section_num, DOWN, buff=0.3)
        
        # Animation
        self.play(Write(section_num), Create(line), run_time=0.8)
        self.play(FadeIn(section_title, shift=DOWN), run_time=1)
        self.play(
            LaggedStart(*[FadeIn(concept, shift=UP) for concept in concepts], lag_ratio=0.3),
            run_time=2.5
        )
        self.wait(2)
        ...
        # Fade out
        self.play(
            FadeOut(VGroup(section_num, section_title, concepts, line)),
            run_time=1
        )
...
class WavesEndCard(Scene):
    """Closing card for the complete lesson"""
    ...
    def construct(self):
        ...
        self.play(
            LaggedStart(*[FadeIn(item, shift=RIGHT*0.5) for item in takeaways], lag_ratio=0.2),
            run_time=2.5
        )
        self.wait(3)
        ...
        # Final fade
        self.play(
            FadeOut(VGroup(title, summary, wave, takeaways)),
            run_time=2
        )
...
class TransitionToLongitudinal(Scene):
    """Transition between transverse and longitudinal waves"""
...
class DidYouKnowSound(Scene):
    """Interesting fact card before sound section"""
...
class TransitionToLight(Scene):
    """Transition from sound to light"""
